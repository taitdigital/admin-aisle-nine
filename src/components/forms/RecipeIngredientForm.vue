            ...
            <div class="flex">
                <div class="flex-shrink-1">
                    <InputNumber 
                        ...
                        :class="{'p-invalid':v$.quantity.$invalid && submitted}  + ' w-6rem'" 
                ...
                <div class="pl-2 flex-shrink-1">
                    <Dropdown
                        ...
                        :class="{'p-invalid':v$.treatment.$invalid && submitted} + ' w-8rem'" 
                        optionLabel="label"
                ...
                <div class="pl-2 flex-shrink-1">
                    <Dropdown
                        ...
                        :class="{'p-invalid':v$.measurement.$invalid && submitted} + ' w-7rem'" 
                        optionLabel="label"
